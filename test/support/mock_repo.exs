# Taken directly from https://github.com/elixir-lang/ecto/blob/master/test/support/mock_repo.exs

defmodule Exseed.MockAdapter do
...
Application.put_env(:ecto, Exseed.MockRepo, [])

defmodule Exseed.MockRepo do
  use Ecto.Repo, otp_app: :ecto, adapter: Exseed.MockAdapter
end
